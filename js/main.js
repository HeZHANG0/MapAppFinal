...
// The three charts. Since age and sex composition data is not available at zip code level, I use static charts for COVID-19 cases by date, age, and sex.
...
var data = "https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_zip&filename=covid_cases_by_zip&format=geojson&skipfields=cartodb_id"
var featureGroup;
